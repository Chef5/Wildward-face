...
Also supports: calories, SpO₂, weather, barometric pressure, Body Battery, stress, respiration rate, sunrise/sunset, weekly/monthly run distance, notifications, and more.

This is my first watch face, and I'm still refining it based on your feedback. Welcome to try it and leave an honest review or suggestions. I typically collect feedback and release an update about every two weeks.
...
此外还支持以下展示：卡路里、血氧、天气、大气压、身体电量、压力值、呼吸频率、日出日落、周跑量、月跑量、消息通知等。

这是我的第一款表盘，目前仍在根据大家的反馈持续打磨。欢迎体验后留下真实评价或宝贵建议。我通常会每隔半个月左右汇总建议并更新一版。
...
此外還支援以下展示：卡路里、血氧、天氣、大氣壓、身體電量、壓力值、呼吸頻率、日出日落、週跑量、月跑量、訊息通知等。

這是我的第一款錶盤，目前仍在根據大家的回饋持續打磨。歡迎體驗後留下真實評價或寶貴建議。我通常會每隔半個月左右彙總建議並更新一版。
...
さらにカロリー、血中酸素、天気、気圧、ボディバッテリー、ストレス、呼吸数、日の出・日の入り、週間/月間走行距離、通知なども表示可能です。

これは私初めてのウォッチフェイスで、皆さまのフィードバックをもとに改善を続けています。ぜひお試しいただき、率直な評価やご提案をお寄せください。通常、約2週間ごとにご意見をまとめてアップデートしています。
...
Zusätzlich unterstützt: Kalorien, SpO₂, Wetter, Luftdruck, Body Battery, Stress, Atemfrequenz, Sonnenauf-/-untergang, Wochen-/Monatslauf-Distanz, Benachrichtigungen u. v. m.

Dies ist mein erstes Zifferblatt – ich verbessere es weiterhin anhand eures Feedbacks. Probiert es aus und hinterlasst eine ehrliche Bewertung oder Vorschläge. In der Regel fasse ich etwa alle zwei Wochen Vorschläge zusammen und veröffentliche ein Update.
...
Également pris en charge : calories, SpO₂, météo, pression atmosphérique, Body Battery, stress, fréquence respiratoire, lever/coucher du soleil, distance de course hebdo/mensuelle, notifications, etc.

C'est mon premier cadran — je l'améliore en continu grâce à vos retours. N'hésitez pas à l'essayer et à laisser un avis ou des suggestions. En général, je compile les retours et publie une mise à jour environ toutes les deux semaines.
...
También admite: calorías, SpO₂, clima, presión barométrica, Body Battery, estrés, frecuencia respiratoria, amanecer/atardecer, distancia semanal/mensual de carrera, notificaciones y más.

Esta es mi primera esfera de reloj y sigo mejorándola según vuestros comentarios. Pruébala y deja una reseña sincera o sugerencias. Suelo recopilar comentarios y publicar una actualización aproximadamente cada quince días.
...
Supporta anche: calorie, SpO₂, meteo, pressione atmosferica, Body Battery, stress, frequenza respiratoria, alba/tramonto, distanza corsa settimanale/mensile, notifiche e altro.

È il mio primo quadrante e continuo a migliorarlo in base ai vostri feedback. Provalo e lascia una recensione sincera o suggerimenti. Di solito raccolgo i commenti e pubblico un aggiornamento circa ogni due settimane.
...
Ook ondersteund: calorieën, SpO₂, weer, luchtdruk, Body Battery, stress, ademhalingsfrequentie, zonsopgang/-ondergang, wekelijkse/maandelijkse hardloopafstand, meldingen en meer.

Dit is mijn eerste wijzerplaat — ik blijf hem verbeteren op basis van jullie feedback. Probeer hem uit en laat een eerlijke review of suggesties achter. Ongeveer om de twee weken bundel ik suggesties en breng ik een update uit.
...
Støtter også: kalorier, SpO₂, vær, lufttrykk, Body Battery, stress, pustefrekvens, soloppgang/solnedgang, ukentlig/månedlig løpedistanse, varsler og mer.

Dette er min første urskive, og jeg forbedrer den fortsatt basert på tilbakemeldinger. Prøv den gjerne og legg igjen en ærlig vurdering eller forslag. Jeg samler vanligvis inn forslag og publiserer en oppdatering omtrent annenhver uke.
...
Obsługuje też: kalorie, SpO₂, pogodę, ciśnienie, Body Battery, stres, częstość oddechów, wschód/zachód słońca, tygodniowy/miesięczny dystans biegu, powiadomienia i inne.

To moja pierwsza tarcza zegarka — wciąż ją udoskonalam na podstawie Waszych opinii. Wypróbujcie ją i zostawcie szczerą recenzję lub sugestie. Zwykle co około dwa tygodnie zbieram uwagi i publikuję aktualizację.
...
Также поддерживается: калории, SpO₂, погода, давление, Body Battery, стресс, частота дыхания, восход/закат, недельный/месячный беговой объём, уведомления и др.

Это мой первый циферблат — я продолжаю его улучшать на основе ваших отзывов. Попробуйте и оставьте честную оценку или предложения. Обычно я собираю пожелания и выпускаю обновление примерно раз в две недели.
...
또한 다음도 지원합니다: 칼로리, 혈중 산소, 날씨, 기압, Body Battery, 스트레스, 호흡수, 일출/일몰, 주간/월간 러닝 거리, 알림 등.

이번이 제 첫 워치페이스이며, 여러분의 피드백을 바탕으로 계속 개선하고 있습니다. 사용해 보시고 솔직한 평가나 제안을 남겨 주세요. 보통 약 2주마다 의견을 모아 업데이트합니다.
