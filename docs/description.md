...
Also supports: calories, SpO₂, weather, barometric pressure, Body Battery, stress, respiration rate, sunrise/sunset, weekly/monthly run distance, notifications, recovery time, intensity minutes, and more.

This is my first watch face, and I'm still refining it based on your feedback. Welcome to try it and leave an honest review or suggestions. I typically summarize feedback once a month and release an update.
...
4. Added support for the fēnix 9 series;
...
此外还支持以下展示：卡路里、血氧、天气、大气压、身体电量、压力值、呼吸频率、日出日落、周跑量、月跑量、消息通知、恢复时间、高强度活动时间等。

这是我的第一款表盘，目前仍在根据大家的反馈持续打磨。欢迎体验后留下真实评价或宝贵建议。我通常会每个月汇总一次建议并更新一版。
...
4. 农历可显示节日与节气（简体/繁体中文）；
5. 新增适配 fēnix 9 系列；

2026.8.22
1. 副色、背景色支持自定义；
2. 修复系统自动进入低功耗模式时秒数秒针停止的问题；
...
此外還支援以下展示：卡路里、血氧、天氣、大氣壓、身體電量、壓力值、呼吸頻率、日出日落、週跑量、月跑量、訊息通知、恢復時間、高強度活動時間等。

這是我的第一款錶盤，目前仍在根據大家的回饋持續打磨。歡迎體驗後留下真實評價或寶貴建議。我通常會每個月彙總一次建議並更新一版。

如果覺得好用，可以打賞一杯咖啡支持一下啦~  :)

專案開源地址：https://github.com/Chef5/Wildward-face
...
さらにカロリー、血中酸素、天気、気圧、ボディバッテリー、ストレス、呼吸数、日の出・日の入り、週間/月間走行距離、通知、リカバリータイム、高強度アクティビティ時間なども表示可能です。

これは私初めてのウォッチフェイスで、皆さまのフィードバックをもとに改善を続けています。ぜひお試しいただき、率直な評価やご提案をお寄せください。通常、毎月ご意見を一度まとめてアップデートしています。
...
Zusätzlich unterstützt: Kalorien, SpO₂, Wetter, Luftdruck, Body Battery, Stress, Atemfrequenz, Sonnenauf-/-untergang, Wochen-/Monatslauf-Distanz, Benachrichtigungen, Erholungszeit, Intensitätsminuten u. v. m.

Dies ist mein erstes Zifferblatt – ich verbessere es weiterhin anhand eures Feedbacks. Probiert es aus und hinterlasst eine ehrliche Bewertung oder Vorschläge. In der Regel fasse ich einmal im Monat Vorschläge zusammen und veröffentliche ein Update.
...
4. Unterstützung für die fēnix-9-Serie hinzugefügt;
...
Également pris en charge : calories, SpO₂, météo, pression atmosphérique, Body Battery, stress, fréquence respiratoire, lever/coucher du soleil, distance de course hebdo/mensuelle, notifications, temps de récupération, minutes d'intensité, etc.

C'est mon premier cadran — je l'améliore en continu grâce à vos retours. N'hésitez pas à l'essayer et à laisser un avis ou des suggestions. En général, je compile les retours une fois par mois et publie une mise à jour.
...
4. Prise en charge de la série fēnix 9 ;
...
También admite: calorías, SpO₂, clima, presión barométrica, Body Battery, estrés, frecuencia respiratoria, amanecer/atardecer, distancia semanal/mensual de carrera, notificaciones, tiempo de recuperación, minutos de intensidad y más.

Esta es mi primera esfera de reloj y sigo mejorándola según vuestros comentarios. Pruébala y deja una reseña sincera o sugerencias. Suelo recopilar comentarios una vez al mes y publicar una actualización.
...
4. Compatibilidad con la serie fēnix 9;
...
Supporta anche: calorie, SpO₂, meteo, pressione atmosferica, Body Battery, stress, frequenza respiratoria, alba/tramonto, distanza corsa settimanale/mensile, notifiche, tempo di recupero, minuti di intensità e altro.

È il mio primo quadrante e continuo a migliorarlo in base ai vostri feedback. Provalo e lascia una recensione sincera o suggerimenti. Di solito raccolgo i commenti una volta al mese e pubblico un aggiornamento.
...
4. Supporto per la serie fēnix 9;
...
Ook ondersteund: calorieën, SpO₂, weer, luchtdruk, Body Battery, stress, ademhalingsfrequentie, zonsopgang/-ondergang, wekelijkse/maandelijkse hardloopafstand, meldingen, hersteltijd, intensiteitsminuten en meer.

Dit is mijn eerste wijzerplaat — ik blijf hem verbeteren op basis van jullie feedback. Probeer hem uit en laat een eerlijke review of suggesties achter. Eén keer per maand bundel ik suggesties en breng ik een update uit.
...
4. Ondersteuning voor de fēnix 9-serie toegevoegd;
...
Støtter også: kalorier, SpO₂, vær, lufttrykk, Body Battery, stress, pustefrekvens, soloppgang/solnedgang, ukentlig/månedlig løpedistanse, varsler, restitusjonstid, intensitetsminutter og mer.

Dette er min første urskive, og jeg forbedrer den fortsatt basert på tilbakemeldinger. Prøv den gjerne og legg igjen en ærlig vurdering eller forslag. Jeg samler vanligvis inn forslag én gang i måneden og publiserer en oppdatering.
...
4. Støtte for fēnix 9-serien lagt til;
...
Obsługuje też: kalorie, SpO₂, pogodę, ciśnienie, Body Battery, stres, częstość oddechów, wschód/zachód słońca, tygodniowy/miesięczny dystans biegu, powiadomienia, czas regeneracji, minuty intensywności i inne.

To moja pierwsza tarcza zegarka — wciąż ją udoskonalam na podstawie Waszych opinii. Wypróbujcie ją i zostawcie szczerą recenzję lub sugestie. Zwykle raz w miesiącu zbieram uwagi i publikuję aktualizację.
...
4. Dodano obsługę serii fēnix 9;
...
Также поддерживается: калории, SpO₂, погода, давление, Body Battery, стресс, частота дыхания, восход/закат, недельный/месячный беговой объём, уведомления, время восстановления, минуты интенсивности и др.

Это мой первый циферблат — я продолжаю его улучшать на основе ваших отзывов. Попробуйте и оставьте честную оценку или предложения. Обычно я собираю пожелания раз в месяц и выпускаю обновление.
...
4. Добавлена поддержка серии fēnix 9;
...
또한 다음도 지원합니다: 칼로리, 혈중 산소, 날씨, 기압, Body Battery, 스트레스, 호흡수, 일출/일몰, 주간/월간 러닝 거리, 알림, 회복 시간, 고강도 활동 시간 등.

이번이 제 첫 워치페이스이며, 여러분의 피드백을 바탕으로 계속 개선하고 있습니다. 사용해 보시고 솔직한 평가나 제안을 남겨 주세요. 보통 한 달에 한 번 의견을 모아 업데이트합니다.
